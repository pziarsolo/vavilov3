# Generated by Django 2.1.5 on 2019-02-20 14:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Ontology',
            fields=[
                ('ontology_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=255, unique=True)),
                ('description', models.CharField(max_length=255)),
                ('ontology', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='vavilov3.Ontology')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='observationvariable',
            name='ontology',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='vavilov3.Ontology'),
        ),
        migrations.AddField(
            model_name='observationvariable',
            name='scale',
